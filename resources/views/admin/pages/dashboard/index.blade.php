    ...
    <body data-ma-theme="teal">
        <main class="main">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu--block">
                            <div class="listview listview--hover">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{asset('admin-page/demo/img/profile-pics/1.jpg')}}" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{asset('admin-page/demo/img/profile-pics/2.jpg')}}" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{asset('admin-page/demo/img/profile-pics/3.jpg')}}" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{asset('admin-page/demo/img/profile-pics/4.jpg')}}" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{asset('admin-page/demo/img/profile-pics/5.jpg')}}" class="listview__img" alt="">
                ...
                <div class="scrollbar-inner">
                    <div class="user">
                        <div class="user__info" data-toggle="dropdown">
                            <img class="user__img" src="{{asset('admin-page/demo/img/profile-pics/8.jpg')}}" alt="">
                            <div>
                ...
                <div class="scrollbar-inner">
                    <div class="listview listview--hover chat__buddies">
                        <a class="listview__item chat__available">
                            <img src="{{asset('admin-page/demo/img/profile-pics/7.jpg')}}" class="listview__img" alt="">
                        ...
                        <a class="listview__item">
                            <img src="{{asset('admin-page/demo/img/profile-pics/8.jpg')}}" class="listview__img" alt="">
                        ...
                        <a class="listview__item">
                            <img src="{{asset('admin-page/demo/img/profile-pics/6.jpg')}}" class="listview__img" alt="">
                        ...
                        <a class="listview__item chat__busy">
                            <img src="{{asset('admin-page/demo/img/profile-pics/9.jpg')}}" class="listview__img" alt="">
            ...
            <section class="content">
                ...
                <div data-columns>
                    <div class="card">
                        <img class="card-img-top" src="{{asset('admin-page/demo/img/widgets/note.png')}}" alt="">
                        <div class="card-body">
                        ...
                        <div class="listview listview--striped">
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('admin-page/demo/img/flags/United_States_of_America.png')}}" alt=""> United States</span>
                                        <span>Firefox</span>
                                        <span>Mac OSX</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('admin-page/demo/img/flags/Australia.png')}}" alt=""> Australia</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('admin-page/demo/img/flags/Brazil.png')}}" alt=""> Brazil</span>
                                        <span>Edge</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('admin-page/demo/img/flags/South_Korea.png')}}" alt=""> South Korea</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('admin-page/demo/img/flags/Japan.png')}}" alt=""> Japan</span>
                                        <span>Chrome</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
