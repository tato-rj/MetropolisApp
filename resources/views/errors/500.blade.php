...
<section class="container-fluid">
    <div class="row" style="min-height: 100vh;">
        <div class="col-lg-6 col-md-6 col-12 d-flex flex-center">
            <div class="px-6">
                <h1 class="text-teal mb-4" style="font-size: 6rem"><strong>500</strong></h1>
                <h4 class="mb-4 text-muted">Hm, o nosso servidor está com dificuldades. Se esse problema continuar, por favor nos avise!</h4>
