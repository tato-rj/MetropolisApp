<table class="table table-hover" id="payments-table">
  ...
  <tbody>
    ...
    <tr class="cursor-pointer payment-item" data-url-status="{{route('status.payment', ['reference' => $payment->reservation->transaction_code])}}" data-modal="#payment-modal" title="Clique para ver mais detalhes">
