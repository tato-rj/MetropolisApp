...
class WorkshopsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        Workshop::create([
            ...
            'fee' => 80,
            'cover_image' => 'workshops/demo1.jpg',
            'capacity' => 12,
            'starts_at' => $startDate,
        ...
        Workshop::create([
            ...
            'fee' => 90,
            'cover_image' => 'workshops/demo2.jpg',
            'capacity' => 12,
            'starts_at' => $startDate,
            'ends_at' => $startDate->copy()->addHours(mt_rand(1,2))
        ]);
        ...
        Workshop::create([
            ...
            'fee' => null,
            'cover_image' => 'workshops/demo3.jpg',
            'capacity' => 8,
            'starts_at' => $startDate,
            'ends_at' => $startDate->copy()->addHours(mt_rand(1,2))
        ]);
        ...
        Workshop::create([
            ...
            'fee' => 80,
            'cover_image' => 'workshops/demo4.jpg',
            'capacity' => 16,
            'starts_at' => $startDate,
            'ends_at' => $startDate->copy()->addHours(mt_rand(1,2))
        ]);
        ...
        Workshop::create([
            ...
            'fee' => null,
            'cover_image' => 'workshops/demo5.jpg',
            'capacity' => 22,
            'starts_at' => $startDate,
            'ends_at' => $startDate->copy()->addHours(mt_rand(1,2))
        ]);
        ...
        Workshop::create([
            ...
            'fee' => 65,
            'cover_image' => 'workshops/demo6.jpg',
            'capacity' => 18,
            'starts_at' => $startDate,
            'ends_at' => $startDate->copy()->addHours(mt_rand(1,2))
        ]);
        ...
        Workshop::create([
            ...
            'fee' => 55,
            'cover_image' => 'workshops/demo7.jpg',
            'capacity' => 22,
            'starts_at' => $startDate,
            'ends_at' => $startDate->copy()->addHours(mt_rand(1,2))
        ]);
