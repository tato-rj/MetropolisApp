...
<section class="container-fluid">
    <div class="row" style="min-height: 100vh;">
        <div class="col-lg-6 col-md-6 col-12 d-flex flex-center">
            <div class="p-5">
                <h1 class="text-teal mb-4" style="font-size: 6rem"><strong>403</strong></h1>
                <h4 class="mb-4 text-muted">Você não tem autorização para acessar nessa página, tem certeza de que queria estar aqui?</h4>
