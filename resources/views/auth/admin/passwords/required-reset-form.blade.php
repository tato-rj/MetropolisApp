<div class="col-lg-8 col-10 mx-auto">
    ...
    <form method="POST" action="{{ route('admin.password.required-save', ['verify' => request('admin')]) }}">
        @csrf

        <div class="form-group">
            <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" 
                name="email" value="{{ request('admin') ?? old('email') }}" placeholder="Email" required autofocus>
